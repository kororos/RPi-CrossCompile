...
if("$ENV{RASPBIAN_ROOTFS}" STREQUAL "")
	message("RASPBIAN_ROOTFS environment variable is not set. Will use default:  /home/lefteris/Projects/pi/rootfs")
    set(SYSROOT_PATH "/home/lefteris/Projects/pi/rootfs")
else()
	set(SYSROOT_PATH "$ENV{RASPBIAN_ROOTFS}")
endif()
set(TOOLCHAIN_HOST "arm-linux-gnueabihf")
set(CROSS_BIN "/opt/cross-pi-gcc/bin/" )
message(STATUS "Using sysroot path: ${SYSROOT_PATH}")

set(TOOLCHAIN_CC "${CROSS_BIN}${TOOLCHAIN_HOST}-gcc")
set(TOOLCHAIN_CXX "${CROSS_BIN}${TOOLCHAIN_HOST}-g++")
set(TOOLCHAIN_LD "${CROSS_BIN}${TOOLCHAIN_HOST}-ld")
set(TOOLCHAIN_AR "${CROSS_BIN}${TOOLCHAIN_HOST}-ar")
set(TOOLCHAIN_RANLIB "${CROSS_BIN}${TOOLCHAIN_HOST}-ranlib")
set(TOOLCHAIN_STRIP "${CROSS_BIN}${TOOLCHAIN_HOST}-strip")
set(TOOLCHAIN_NM "${CROSS_BIN}${TOOLCHAIN_HOST}-nm")
